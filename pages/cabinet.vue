...
export default {
  ...
  methods: {
    ...
    save() {
      if (!!this.model.id) {
        http.api.cabinet.update(this.model.id, this.model)
            .then(() => {
              this.getData(this.searchData)
            })
      } else {
        http.api.cabinet.save(this.model)
            .then(() => {
              this.getData(this.searchData)
            })
      }
    ...
    getData(search) {
      ...
      http.api.cabinet.list(search.rsql, search.page, search.search, search.sort)
          .then(r => {
            this.data = r.content
            this.total = r.total
          })
